...
*/
var PHRASING_ELEMENTS = {a:{},abbr:{},acronym:{},applet:{hasBlock:true,embed:true},b:{},basefont:{empty:true,embed:true},bdo:{},big:{},br:{empty:true},button:{hasBlock:true},cite:{},code:{},del:{},dfn:{},em:{},font:{},i:{},iframe:{hasBlock:true,embed:true},img:{empty:true},input:{empty:true},ins:{},isindex:{empty:true},kbd:{},label:{},map:{hasBlock:true,embed:true},object:{hasBlock:true,embed:true},q:{},s:{},samp:{},select:{hasBlock:true},small:{},span:{},strike:{},strong:{},sub:{},sup:{},textarea:{},tt:{},u:{},var:{},ruby:{hasBlock:true},audio:{hasBlock:true,embed:true},bdi:{},canvas:{hasBlock:true,embed:true},data:{},embed:{empty:true,embed:true},keygen:{empty:true,embed:true},mark:{},meter:{},output:{},progress:{},template:{hasBlock:true},time:{},video:{hasBlock:true,embed:true},wbr:{empty:true},math:{embed:true},svg:{hasBlock:true},tspan:{hasBlock:true},tref:{hasBlock:true},altglyph:{}};
